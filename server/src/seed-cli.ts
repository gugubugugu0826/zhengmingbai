...
function seedV31AiConfigs(): void {
  ...
  putConfigIfAbsent('ai.vision_model', 'doubao-seed-2-1-turbo-260628'); // v3.2：火山控制台已确认（对齐 llm/vision 客户端默认值）
  putConfigIfAbsent('ai.text_model', 'doubao-seed-2-1-turbo-260628'); // v3.2：火山控制台已确认（对齐 llm/vision 客户端默认值）
